...
//    printf("No existing value.\n");
//    new_value->assign(value.data(), value.size());
//    success = true;
//  } else {
//    printf("Existing value. Setting handles\n");
...
//    printf("Existing value. Done setting handles\n");
...
//    printf("Done calling java method\n");
...
//      printf("No Exception\n");
      ...
      if (jNewValue != NULL) {
        ...
        new_value->assign(cppNewValue, len);
